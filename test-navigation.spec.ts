...
test.describe('Navigation and Pages Test', () => {
  ...
  test('should have correct branding - Persona not PersonaPass', async ({ page }) => {
    ...
    await expect(page.getByText('PersonaPass')).not.toBeVisible();
  ...
  test('should have clean navigation without dropdowns', async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="navigation"], nav', { timeout: 10000 });
  ...
  test('should have working create credentials functionality', async ({ page }) => {
    ...
    await expect(page.getByText('Create First Credential')).toBeVisible();
    
    // Look for credential creation options
    const credentialTypes = ['GitHub', 'LinkedIn', 'Plaid', 'Manual'];
  ...
  test('should have proper responsive design', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="mobile-menu-button"], button[aria-label*="menu"]')).toBeVisible();
  ...
  test('should handle errors gracefully', async ({ page }) => {
    ...
    // Most SPAs redirect to the main page
    await page.waitForLoadState('networkidle');
